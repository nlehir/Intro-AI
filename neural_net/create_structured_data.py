...
if not os.path.exists("./data/"):
    os.makedirs("./data/")
np.save("data/training_inputs_std_" + str(noise_std_dev) + ".npy", inputs_training)
np.save("data/test_inputs_std_" + str(noise_std_dev) + ".npy", inputs_test)

np.save("data/training_outputs_std_" + str(noise_std_dev) + ".npy", outputs_training)
np.save("data/test_outputs_std_" + str(noise_std_dev) + ".npy", outputs_test)
